...
router.use(authenticate, authorize([UserRole.ADMIN, UserRole.VETERINARIO])); // Solo veterinarios y admins pueden acceder
...
router.put('/:id', updateMedicalValidator, validateDto, medicalController.updateMedicalRecord);
